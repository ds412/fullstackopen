...
import {
    Alert, AppBar, Button, Container, IconButton, Paper, Table, TableBody, TableCell,
    TableContainer, TableRow, TextField, Toolbar,
} from '@mui/material'
...
const App = () => {
    ...
    const [message, setMessage] = useState(null) // notification to be displayed
